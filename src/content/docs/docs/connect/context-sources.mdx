...
<Aside type="tip">
  You can connect and scope context sources by hand as this page describes, or ask Promptless in Slack or Microsoft Teams to do it for you. For example, "@Promptless add Notion as a context source." See [Ask Promptless to update your configuration](/docs/get-the-most-out/ask-promptless-to-update-config).
</Aside>
