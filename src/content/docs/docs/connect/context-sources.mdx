...
<CardGroup cols={2}>
  <Card title="Linear" iconSrc="/assets/linear-logo.svg" iconAlt="Linear logo" href="/docs/connect/context-sources/linear">
    Access Linear issues, projects, and team workflows for project management context
  </Card>

  <Card title="Jira" iconSrc="/assets/jira-logo.svg" iconAlt="Jira logo" href="/docs/connect/context-sources/jira">
    Query Jira tickets and project data using JQL search capabilities
  </Card>

  <Card title="Confluence" iconSrc="/assets/confluence-logo.svg" iconAlt="Confluence logo" href="/docs/connect/context-sources/confluence">
    Search Confluence spaces for existing documentation patterns, terminology, and architectural decisions
  </Card>

  <Card title="Notion" iconSrc="/assets/notion-logo.svg" iconAlt="Notion logo" href="/docs/connect/context-sources/notion">
    Search Notion pages and databases for product specs, internal documentation, and team knowledge
  </Card>

  <Card title="Google Drive" iconSrc="/assets/google-drive-logo.svg" iconAlt="Google Drive logo" href="/docs/connect/context-sources/google-drive">
    Search Google Drive and read Docs, Sheets, and Slides for product specs, internal notes, and reference material
  </Card>

  <Card title="Slite" iconSrc="/assets/slite-logo.svg" iconAlt="Slite logo" href="/docs/connect/context-sources/slite">
