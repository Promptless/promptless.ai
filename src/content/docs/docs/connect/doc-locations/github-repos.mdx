...
"Platform" here means the documentation framework your site is built with, not where the repository is hosted. The same framework list applies whether your docs repository lives in GitHub or in a [GitLab project](/docs/connect/doc-locations/gitlab-projects). Promptless publishes to any of these frameworks:
