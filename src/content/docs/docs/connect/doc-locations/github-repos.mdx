...
<Aside type="note">
  In the dashboard, creating, editing, and deleting doc collections requires the organization Admin role. All members can still view the doc collection list.
</Aside>
