...
<Aside type="tip">
  You can set up triggers by hand as this page describes, or ask Promptless in Slack or Microsoft Teams to do it for you. For example, "@Promptless add a GitHub PR trigger for my acme/api repo." See [Ask Promptless to update your configuration](/docs/get-the-most-out/ask-promptless-to-update-config).
</Aside>
...
<CardGrid>
  ...
  <LinkCard title="Jira" href="/docs/connect/triggers/jira" description="Start a session from a Jira ticket and reply on the ticket" />
  ...
  <LinkCard title="Schedule" href="/docs/connect/triggers/schedule" description="Run standing instructions on a repeating cron schedule" />

  <LinkCard title="MCP" href="/docs/connect/triggers/mcp" description="Start documentation tasks from your editor over MCP—no API key required" />
</CardGrid>
