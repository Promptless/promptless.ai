...
<Aside type="tip">
  You can connect and scope this context source by hand as this page describes, or ask Promptless in Slack or Microsoft Teams to do it for you. For example, "@Promptless add Linear as a context source scoped to my engineering and product teams." See [Ask Promptless to update your configuration](/docs/get-the-most-out/ask-promptless-to-update-config).
</Aside>
