---
title: GitHub issues
description: Mention @Promptless in a GitHub issue to turn a documentation request into a reviewed suggestion.
slug: docs/for-docs/connect/triggers/github-issues
type: reference
tags:
  - connect
  - triggers
...
<Aside type="note">
  GitHub Issues triggers require the GitHub App installation. See the [GitHub Integration](/docs/for-docs/reference/integrations/github) setup guide if you haven't connected GitHub yet.
</Aside>
