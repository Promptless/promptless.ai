...
description: Turn recurring questions in closed Intercom support conversations into documentation suggestions that close the gaps behind them.
slug: docs/for-docs/connect/triggers/intercom-tickets
type: reference
tags:
  - connect
  - triggers
...
To connect Intercom to Promptless, see the [Intercom Integration](/docs/for-docs/reference/integrations/intercom) setup guide.
