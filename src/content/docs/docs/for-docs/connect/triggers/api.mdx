...
A [Jira Automation rule](/docs/for-docs/connect/triggers/jira-automation-api) can call this API as a custom integration, so a Jira event you choose starts a documentation update.
