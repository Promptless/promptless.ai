...
<Aside type="tip">
  Replay is also available for [GitLab merge requests](/docs/for-docs/connect/triggers/gitlab-merge-requests#replay-recent-merge-requests). When you enable multiple code review triggers during onboarding, the replay preview groups results by provider.
</Aside>
