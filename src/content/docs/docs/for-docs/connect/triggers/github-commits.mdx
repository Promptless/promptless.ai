...
description: Trigger documentation suggestions from direct commits to your default branches, for teams that merge without pull requests or ship hotfixes.
slug: docs/for-docs/connect/triggers/github-commits
type: reference
tags:
  - connect
  - triggers
...
<Aside type="note">
  Adding, renaming, or modifying a GitHub commit trigger requires the GitHub integration to be connected first. See [Connect a provider before you add its triggers](/docs/for-docs/connect/triggers#connect-a-provider-before-you-add-its-triggers).
</Aside>
...
When creating a new project with a GitHub commit trigger, you can enable **Process last 30 days of commits**. This generates initial documentation suggestions from your recent commit history. This is useful for:
...
Commit triggers don't create PR comments. To receive updates when Promptless creates or updates suggestions, configure a Slack notification channel in your [publishing policies](/docs/for-docs/reference/configuration-reference#policies):
...
Enable auto-merge in your [publishing policies](/docs/for-docs/reference/configuration-reference#policies):
