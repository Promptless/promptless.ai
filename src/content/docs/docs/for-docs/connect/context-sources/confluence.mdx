...
<Aside type="tip">
  You can connect and scope this context source by hand as this page describes, or ask Promptless in Slack or Microsoft Teams to do it for you. For example, "@Promptless scope the Confluence context source to my Engineering space." See [Ask Promptless to update your configuration](/docs/for-docs/get-the-most-out/ask-promptless-to-update-config).
</Aside>
