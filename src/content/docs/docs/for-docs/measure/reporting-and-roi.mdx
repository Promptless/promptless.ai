...
<Aside type="note">
  Learn your way around the surfaces this page draws on: the Suggestions list and Triggers page in [Use the web interface](/docs/for-docs/work-the-queue/web-interface), and where lasting context lives in the [Agent Knowledge Base](/docs/for-docs/get-the-most-out/agent-knowledge-base).
</Aside>
