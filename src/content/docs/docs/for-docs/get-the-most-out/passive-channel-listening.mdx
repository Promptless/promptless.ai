...
<Aside type="tip" title="Before You Begin">
  - **Promptless joins your public passive-listening channels automatically**, so you don't need to invite it to those. For a private channel—or a channel shared with another workspace through Slack Connect—you must still [add Promptless in Slack](/docs/for-docs/reference/integrations/slack#add-promptless-to-private-channels) before it can read messages there.
