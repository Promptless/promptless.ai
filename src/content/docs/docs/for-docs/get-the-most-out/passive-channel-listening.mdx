...
<Aside type="tip" title="Before You Begin">
  - **Promptless joins your public passive-listening channels automatically**, so you don't need to invite it to those. Promptless can't self-join a private channel or a channel shared with another workspace through Slack Connect. For those, [add Promptless in Slack](/docs/for-docs/reference/integrations/slack#add-promptless-to-private-channels) yourself. Then Promptless can read messages there.
