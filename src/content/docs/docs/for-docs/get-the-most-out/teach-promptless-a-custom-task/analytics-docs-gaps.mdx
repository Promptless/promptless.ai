...
<Aside type="note">
  This example uses PostHog as an analytics source. The workflow can be generalized to support whichever tool or platform you use to store your analytics.
</Aside>
