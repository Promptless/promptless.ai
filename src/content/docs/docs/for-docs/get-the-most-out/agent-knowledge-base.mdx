...
<Aside type="note">
  These files are Promptless's best inferences from your docs, commit history, and public site—not confirmed facts. Organization admins can [edit any of them](#edit-files) to correct or refine what Promptless assumes, and Promptless treats those edits as ground truth for future tasks.
</Aside>
...
<Aside type="caution">
  If you point a collection at a different repository in your collection's configuration, Promptless re-analyzes from scratch and replaces all six files, including any edits you've made. Copy anything you want to keep first.
</Aside>
