...
If Slack is connected and you picked or kept a notification channel, Promptless posts updates there as the run progresses and again when the suggestions are ready for review.
