...
<Aside type="tip">
  Auditing, remediating, or restructuring an existing docs set? See [Audit and keep your docs healthy](/docs/for-docs/audit/keep-docs-healthy) for how Deep Analysis fits alongside Vale, Doc Detective, and redirects on those jobs.
</Aside>
...
<Steps>
  1. **Open New Task.** Click **New Task** in the sidebar. You can also use the [Deep Analysis deep link](https://app.gopromptless.ai/new-task?mode=deep), which opens New Task with **Deep analysis** already selected in the **Mode** chip.
