...
<Aside type="note">
  This page covers both Slack and Microsoft Teams. The sections below describe the Slack workflow; jump to [Microsoft Teams](#microsoft-teams) for the Teams equivalent. Make sure you have the [Slack integration](/docs/for-docs/reference/integrations/slack) set up before using these Slack features.
</Aside>
