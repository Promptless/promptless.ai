...
## Find your first documentation update

Once Promptless has analyzed your documentation and you have connected source repositories, open **New Task**. Under **Use a template**, select **Find doc update from recent merges**. The template fills in a prompt that asks Promptless to find one documentation update from recently merged pull requests or merge requests. It uses **Default** mode and is ready to submit without filling in placeholders.

Click the submit arrow to start. The card is marked **Recommended** when your organization has no open suggestions. See [Find a doc update from recent merges](/docs/for-docs/work-the-queue/web-interface#find-a-doc-update-from-recent-merges) for the full steps and how to follow progress.
