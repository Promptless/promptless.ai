...
You don't have to wait for the next pull request to see a suggestion. Once indexing finishes, open [New Task](https://app.gopromptless.ai/new-task) and select the **Find doc update from recent merges** template. Promptless reviews your recently merged pull requests, picks one change that needs a docs update, and creates one suggestion for it. While your organization has no open suggestions, that card carries a **Recommended** badge. See [Find a doc update from recent merges](/docs/for-docs/work-the-queue/web-interface#find-a-doc-update-from-recent-merges).
