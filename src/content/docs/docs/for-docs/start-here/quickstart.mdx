...
<Aside type="tip">
  No admin access for an integration? Invite someone from IT or Engineering directly from the onboarding wizard. They'll get an email linking to the same page and can pick up right where you left off.
</Aside>
