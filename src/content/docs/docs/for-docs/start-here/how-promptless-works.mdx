...
![Diagram of how triggers, context sources, and doc collections connect in Promptless](/mermaid/how-it-works.svg)
...
<section id="core-concepts-workflow" class="pl-site-steps is-compact" data-sticky-heading="false">
  <div class="pl-site-step-list">
    <article class="pl-site-step" id="triggers-initiate-the-process">
      ...
      <ul>
        <li>
          <strong>Code Changes</strong>: GitHub pull requests, commits, and issues, and GitLab merge requests,
          trigger analysis when new features or fixes are introduced
        </li>
        ...
        <li>
          <strong>Tickets and Automation</strong>: Jira tickets, API calls, MCP requests from your editor, and
          recurring schedules can start documentation work
        </li>
      </ul>
    ...
    <article class="pl-site-step" id="context-sources-enrich-understanding">
      ...
      <ul>
        ...
        <li>
          <strong>Knowledge bases</strong>: Confluence, Notion, Google Drive, and Slite carry specs, decisions, and existing
          product context
        </li>
      </ul>
...
<Aside type="tip">
  Ready to tune how triggers, context sources, and doc collections behave for your team? See [Configuring Promptless](/docs/for-docs/connect/triggers), or contact us at [help@gopromptless.ai](mailto\:help@gopromptless.ai) for setup guidance.
</Aside>
