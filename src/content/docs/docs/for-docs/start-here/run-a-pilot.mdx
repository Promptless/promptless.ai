...
<Steps>
  1. **Understand your Promptless setup.** Review your configuration and how [triggers, context sources, and documentation platforms](/docs/for-docs/start-here/how-promptless-works) work for your team
