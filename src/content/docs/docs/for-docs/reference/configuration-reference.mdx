...
<details>
  ...
  Triggers when a release tag matching a pattern is pushed to specified repositories.
  ...
  **Match clause fields:**
  ...
  | `branches`       | Optional. When set, the branch a tag was cut from must be listed; an empty list matches any branch. A `github_commit` trigger's empty `branches` matches only its default branch. |
  | `repo_topics`    | Only trigger for repos with these GitHub topics                                                                                                                                   |
  | `repo_owners`    | Only trigger for repos owned by these owners                                                                                                                                      |
</details>
