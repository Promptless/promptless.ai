...
<details>
  ...
  Passively monitors specified Slack channels for documentation-worthy conversations. Promptless joins configured public channels automatically; private channels and channels shared with another workspace through Slack Connect must have Promptless added in Slack before they can be monitored.
