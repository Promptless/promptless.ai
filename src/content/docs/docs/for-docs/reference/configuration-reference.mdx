...
<details>
  ...
  Passively monitors specified Slack channels for documentation-worthy conversations. Promptless joins configured public channels automatically. Private channels and channels shared with another workspace through Slack Connect need you to add Promptless in Slack before it can monitor them.
