...
description: Connect Linear through OAuth so Promptless reads your project management data for documentation context.
slug: docs/for-docs/reference/integrations/linear
type: reference
tags:
  - reference
  - integrations
...
- Linear rejected or revoked Promptless's access, which can happen when someone removes the Promptless authorization in Linear
...
Once connected, you can use Linear as a [context source](/docs/for-docs/connect/context-sources/linear) to search for related issues and project management data that enhances documentation accuracy.
