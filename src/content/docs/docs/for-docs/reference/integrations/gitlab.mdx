...
- Deliver merge-request comments that mention Promptless, so a tagged comment can request documentation work. See [Request documentation via merge-request comments](/docs/connect/triggers/gitlab-merge-requests#request-documentation-via-merge-request-comments).
