...
description: Connect Intercom so Promptless turns support conversations and repeated questions into documentation updates.
...
Intercom can also be used as a [trigger source](/docs/for-docs/connect/triggers) to monitor support conversations for documentation gaps; contact us to enable this for your organization (Beta).
