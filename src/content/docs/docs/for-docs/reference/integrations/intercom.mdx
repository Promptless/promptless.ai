...
Once connected, you can use Intercom as a [trigger source](/docs/for-docs/connect/triggers/intercom-tickets) to monitor support conversations for documentation gaps (Beta).
