...
description: Connect Bitbucket with app password authentication so Promptless monitors your pull requests for documentation updates.
slug: docs/for-docs/reference/integrations/bitbucket
type: reference
tags:
  - reference
  - integrations
...
<Aside type="tip" title="Creating a Bitbucket App Password">
...
When setting up a new Bitbucket PR trigger, you can enable "Replay recent PRs" to process pull requests from the last 30 days. This generates an initial batch of suggestions, which helps you:
...
For more information on how triggers work in general, see the [Triggers](/docs/for-docs/start-here/how-promptless-works) documentation.
