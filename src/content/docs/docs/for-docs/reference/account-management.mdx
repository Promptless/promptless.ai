...
Billing is a page in the dashboard Settings, visible only to **`Admin`** users in organizations on a paid plan. Organizations that aren't on a paid plan—including free and trial organizations—and non-admins won't see it, and anyone who navigates to it directly sees a restricted-access message.
