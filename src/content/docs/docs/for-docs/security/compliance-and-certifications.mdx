...
description: Review Promptless's SOC 2 Type II certification, security practices, and incident response for your security review.
slug: docs/for-docs/security/compliance-and-certifications
type: reference
tags:
  - security
  - reference
...
For questions about our compliance practices, contact our team at [help@gopromptless.ai](mailto\:help@gopromptless.ai). Use the same address to request compliance documentation. For specific security requirements, contact [security@gopromptless.ai](mailto\:security@gopromptless.ai).
