...
slug: docs/for-docs/security/self-hosting
type: landing
tags:
  - security
  - landing
...
<LinkCard title="Kubernetes Deployment Guide" href="/docs/for-docs/security/self-hosting/kubernetes-helm" description="Complete installation guide for deploying Promptless on Kubernetes using Helm charts" />
...
<CardGrid>
  <LinkCard title="Contact Sales" href="mailto:hello@gopromptless.ai" description="Discuss your self-hosting requirements and enterprise licensing" />

  <LinkCard title="Technical Support" href="mailto:help@gopromptless.ai" description="Get technical assistance with deployment and configuration" />
</CardGrid>
