...
description: How Promptless handles your data, why it does not store your source code or conversations, and why it does not train models on your content.
slug: docs/for-docs/security/privacy-policy
type: reference
tags:
  - security
  - reference
...
For questions about our privacy practices or to exercise your data rights, contact us at [help@gopromptless.ai](mailto\:help@gopromptless.ai).
