...
Promptless offers a Data Processing Agreement for customers who need one to comply with GDPR, UK GDPR, CCPA, or similar data protection regulations.

Our DPA is based on the [Common Paper DPA v1.1](https://commonpaper.com/standards/data-processing-agreement/1.1/) standard terms. The DPA covers:

- Processor and subprocessor relationships
- Processing instructions and purposes
- Restricted transfers and Standard Contractual Clauses (SCCs)
- Security incident notification
- Audit rights
- Data deletion procedures

To request a DPA, contact security@gopromptless.ai.
