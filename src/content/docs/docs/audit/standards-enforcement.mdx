...
slug: docs/audit/standards-enforcement
sidebar:
  hidden: false
  order: 36
...
<Aside type="note">
Vale is one of the tools behind [Audit and keep your docs healthy](/docs/audit/keep-docs-healthy) — it holds restandardized pages on-style so legacy content doesn't drift again after you fix it.
</Aside>
