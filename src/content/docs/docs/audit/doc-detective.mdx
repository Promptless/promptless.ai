...
<Aside type="note">
  Executable tests are one of the tools behind [Audit and keep your docs healthy](/docs/audit/keep-docs-healthy) — they keep remediated procedures true as the product changes, so a workflow you just fixed doesn't quietly go stale again.
</Aside>
