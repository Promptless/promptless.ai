...
{/* test {"testId": "account-management-navigation", "description": "Verify the documented account management interface: open the organization Manage modal and confirm the team-management and verified-domains controls are present"} */}
{/* step {"record": ".doc-detective/results/account-management-navigation.mp4"} */}
...
{/* step {"find": {"selector": "button.cl-formButtonPrimary", "click": true, "timeout": 5000}} */}
{/* step {"wait": 5000} */}
{/* step {"goTo": "https://app.gopromptless.ai"} */}
{/* step {"find": {"selector": "button.cl-organizationSwitcherTrigger", "click": true, "timeout": 10000}} */}
{/* step {"find": {"selector": "text=Manage", "click": true, "timeout": 5000}} */}
{/* step {"find": {"selector": "text=Verified domains", "timeout": 10000}} */}
