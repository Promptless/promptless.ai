...
- [Google Drive](/docs/configuring-promptless/context-sources/google-drive): Search Google Drive and read Docs, Sheets, and Slides for context when creating documentation
