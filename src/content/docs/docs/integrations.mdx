...
- [Microsoft Teams](/docs/integrations/microsoft-teams-integration): Trigger based on mentions, message actions, and passive channel listening in Microsoft Teams (Beta)
