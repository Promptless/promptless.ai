...
- [Microsoft Teams](/docs/integrations/microsoft-teams-integration): Trigger based on mentions, message actions, and passive channel listening in Microsoft Teams
- [Notion](/docs/configuring-promptless/context-sources/notion): Search Notion pages and databases for product specs and internal documentation
- [Google Drive](/docs/configuring-promptless/context-sources/google-drive): Search Google Drive and read Docs, Sheets, and Slides for context when creating documentation (Beta)
- [Slite](/docs/configuring-promptless/context-sources/slite): Search Slite notes for internal documentation and product context
