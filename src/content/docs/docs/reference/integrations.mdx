...
- [GitHub (read-only)](/docs/reference/integrations/github-read-only): Separate read-only GitHub App for public repositories — triggers, context, and publishing to public repos through a pull request from a fork
