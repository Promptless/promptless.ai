...
Promptless integrates with GitLab using group access token authentication. It monitors merge requests in your repositories for documentation updates, follows GitLab.com merge request links and reads source code for deeper context, and can publish documentation to GitLab projects by opening merge requests. Both gitlab.com and self-hosted GitLab are supported.
