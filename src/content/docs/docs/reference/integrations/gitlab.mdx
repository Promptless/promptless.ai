...
Promptless integrates with GitLab using group access token authentication, monitoring merge requests in your repositories for documentation updates, follow GitLab.com MR links, and providing read access to source code for deeper context.
