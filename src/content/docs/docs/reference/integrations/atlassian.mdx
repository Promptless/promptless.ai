...
Promptless connects to Atlassian-hosted Jira Cloud instances over OAuth 2.0.

<Note>
Promptless no longer supports self-hosted Jira Data Center or Server instances. You can connect only Atlassian-hosted Jira Cloud.
</Note>
