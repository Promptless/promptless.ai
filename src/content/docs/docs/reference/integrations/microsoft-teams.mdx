...
Connecting Teams happens in two parts: sign in with Microsoft to link your tenant to your Promptless organization, then install the Promptless app in your Teams tenant. Until your tenant is connected, the Promptless bot replies that no workspace is connected, because it can't map incoming Teams messages back to your organization.

### Step 1: Sign in with Microsoft

1. From the [Promptless integrations page](https://app.gopromptless.ai/integrations), find the **Microsoft Teams** integration and click **Enable**.
2. Sign in with a Microsoft work account for your tenant and approve the sign-in. This links your Microsoft tenant to your Promptless organization.

If the Microsoft Teams integration shows **Contact Promptless** instead of **Enable**, reach out to [help@gopromptless.ai](mailto\:help@gopromptless.ai) to finish connecting.

### Step 2: Download Promptless Teams app package

Next, download the Promptless Teams app package from the [Promptless integrations page](https://app.gopromptless.ai/integrations):
...
### Step 3: Upload Promptless Teams app
