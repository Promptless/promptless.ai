...
## Administering Microsoft Teams file access

To let Promptless read the SharePoint-hosted files behind your Teams channels, a tenant administrator grants access to specific SharePoint sites with a PowerShell command block Promptless generates. See [Microsoft Teams administration](/docs/reference/integrations/microsoft-teams-administration) for the full walkthrough.
