...
slug: docs/reference/integrations/github-enterprise
type: reference
tags:
  - reference
  - integrations
...
<Aside type="caution">
  This setup is required for GitHub Enterprise Server instances and GitHub Enterprise Cloud organizations that don't allow third-party GitHub Apps. For standard GitHub.com organizations, use the [standard GitHub integration](/docs/reference/integrations/github) instead.
</Aside>
