...
This applies to standard GitHub.com organizations. If you use GitHub Enterprise, see the [GitHub Enterprise Setup Guide](/docs/reference/integrations/github-enterprise) for the full list of addresses to allow.
