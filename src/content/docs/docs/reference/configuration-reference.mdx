...
| `auto_merge`                  | Automatically merge auto-created documentation PRs. On GitLab the merge is immediate and squashes, and a merge request that can't merge right away stays open for you to merge manually ([full detail](/docs/connect/doc-locations/gitlab-projects#automatic-merge-request-creation)) |
