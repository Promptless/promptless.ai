...
{/* test {"testId": "microsoft-teams-integration-content"} */}
{/* step {"goTo": "https://promptless.ai/docs/integrations/microsoft-teams-integration"} */}
{/* step {"find": "Microsoft Teams Integration (Beta)"} */}
...
{/* step {"find": "Step 1: Download Promptless Teams App Package"} */}
...
{/* step {"find": "Step 2: Upload Promptless App"} */}
...
{/* step {"find": "Step 3: Grant Access to Users"} */}
...
{/* step {"find": "What You Can Do with Microsoft Teams"} */}
## What You Can Do with Microsoft Teams

Once connected, you can use Microsoft Teams for:

{/* step {"checkLink": {"url": "https://promptless.ai/docs/configuring-promptless/triggers/microsoft-teams-messages"}} */}
