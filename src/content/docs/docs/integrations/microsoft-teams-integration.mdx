...
1. From the [Promptless integrations page](https://app.gopromptless.ai/integrations), click **Connect Microsoft Teams**.
2. Under **Connect your Microsoft tenant**, click **Sign in with Microsoft**.
3. Sign in with a Microsoft work account for your tenant and approve the sign-in. This links your Microsoft tenant to your Promptless organization.

If you don't see the **Sign in with Microsoft** button, contact [help@gopromptless.ai](mailto:help@gopromptless.ai) to finish connecting.
