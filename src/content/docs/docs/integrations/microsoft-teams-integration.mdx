...
{/* test {"testId":"ms-teams-integration-setup","description":"Validate that the documented Microsoft Teams integration setup destinations are reachable"} */}
...
{/* step {"description":"The Promptless integrations page (where the Teams app package is downloaded) is reachable","checkLink":"https://app.gopromptless.ai/integrations"} */}
...
{/* step {"description":"The Microsoft Teams admin center (where the app is uploaded and configured) is reachable","checkLink":"https://admin.teams.microsoft.com"} */}
{/* test end */}
