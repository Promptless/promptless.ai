...
Once connected, you can use Intercom as a [trigger source](/docs/configuring-promptless/triggers) to monitor support conversations for documentation gaps (Beta).
