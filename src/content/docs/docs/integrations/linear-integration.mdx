...
1. Click "Reconnect Linear" on the warning card
2. Sign in to Linear when prompted
3. Authorize Promptless to access your Linear workspace

After reconnecting, the warning disappears and Promptless can access your Linear issues again.
