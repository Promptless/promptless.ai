...
By default, Promptless only reads Slack content when you explicitly trigger it by tagging @Promptless or using the "Update Docs" message action. If you enable passive listening in your [configuration](/docs/configuring-promptless/configuration-reference#triggers), Promptless will monitor only the specific channels you configure.
