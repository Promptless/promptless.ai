...
{/* test {"testId": "atlassian-integration-content"} */}
{/* step {"goTo": "https://promptless.ai/docs/integrations/atlassian-integration"} */}
{/* step {"find": "Atlassian Integration"} */}
...
{/* step {"find": "Permissions Required"} */}
...
{/* step {"find": "Jira Cloud Installation"} */}
...
{/* step {"find": "What You Can Do with Atlassian"} */}
...
{/* step {"checkLink": {"url": "https://promptless.ai/docs/configuring-promptless/context-sources/jira"}} */}
...
{/* step {"checkLink": {"url": "https://promptless.ai/docs/configuring-promptless/context-sources/confluence"}} */}
...
{/* step {"find": "Provisioning an Atlassian Account for Promptless"} */}
...
{/* step {"find": "Data Processing and Security"} */}
