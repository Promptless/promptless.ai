...
<HowItWorks
  ...
  steps={[
    ...
    },
    {
      id: 'connect-docs',
      label: 'Connect docs',
      description: 'Connect one or more GitHub repositories—documentation repos and code repos—and review your sources before continuing. Add additional doc collections at any time.',
    },
    {
...
- **GitHub repos**: Works with docs-as-code platforms like ReadMe, Mintlify, Fern, Docusaurus, and more. Connect multiple repositories during setup—docs repos become doc collections, while code repos serve as trigger sources for those collections.
