...
<HowItWorks
  ...
  steps={[
    ...
    },
    {
      id: 'connect-docs',
      label: 'Connect docs',
      description: 'Install the Promptless GitHub App and connect one or more repositories—documentation repos and code repos—reviewing your sources before continuing. This is the only required step: selecting a docs repo automatically creates your first doc collection, and you can add more doc collections at any time.',
    },
    {
      id: 'connect-triggers',
