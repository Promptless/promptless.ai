...
After completing setup, Promptless will start ingesting and indexing your documentation. This process helps Promptless learn your documentation structure and content, and remember it for future suggestions. This can take 5-30 minutes, depending on the size of your docs.
...
Your configuration is stored in a `promptless.yaml` file that you can edit anytime in the [Configuration page](https://app.gopromptless.ai/configuration). See the [Configuration Reference](/docs/configuring-promptless/configuration-reference) for the complete schema.
