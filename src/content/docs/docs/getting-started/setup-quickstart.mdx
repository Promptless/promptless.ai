...
<HowItWorks
  ...
  steps={[
    ...
    },
    {
      id: 'connect-docs',
      label: 'Connect docs',
      description: 'Tell Promptless where your code lives, then install the GitHub App to connect your docs repository.',
    },
    {
...
### About the Connect docs step

Before installing the GitHub App, Promptless asks two questions:

1. **Where are your docs-as-code?** — Select GitHub.com if your documentation repository is hosted there. If your docs live elsewhere, select "Somewhere else" to contact us about other options.

2. **Source code & product changes** — Tell us where your engineers open pull requests. Promptless watches these repositories to know when your docs need updating. You can select multiple platforms: GitHub.com, GitHub Enterprise Cloud, GitLab.com, and Bitbucket.com are all supported.

<Tip>
If you use self-hosted platforms like GitHub Enterprise Server, GitLab Self-Managed, or Bitbucket Data Center, select those options to book a quick call with our team—we'll help you get set up.
</Tip>

These questions help determine which repositories the GitHub App needs access to, so your admin only has to approve once.
...
- **GitHub/GitLab/Bitbucket**: Auto-trigger from pull requests
