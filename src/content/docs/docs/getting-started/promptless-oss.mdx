  ...
  <div class="pl-site-step-list">
    <article class="pl-site-step" id="install-the-github-app">
      ...
      <ul>
        ...
        <li>
          <strong>GitHub OSS app (read-only)</strong>: For public repositories only. If you can only install read-only apps, Promptless creates
          PRs from a fork. Private repositories are not supported with this integration—use the standard GitHub app instead. See the <a href="/docs/integrations/github-integration">GitHub integration docs</a> for
          details.
        </li>
      </ul>
    </article>
...
=======
        To calibrate before going live, you can ask Promptless create an initial batch of suggestions by looking back over the last 30 days.
        For PR triggers enable <strong>Replay recent PRs</strong> or for Commit trigger enable <strong>Process last 30 days of commits</strong>.
>>>>>>> main
      </Tip>
      <p>
