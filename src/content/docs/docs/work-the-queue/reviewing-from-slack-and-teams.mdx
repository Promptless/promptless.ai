...
Once the Teams integration is connected, @Promptless mentions are always active—no YAML configuration required. For the trigger types, passive-listening setup, and publishing behavior, see the [Triggers](/docs/connect/triggers) overview.
