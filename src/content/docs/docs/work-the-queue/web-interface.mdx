...
When no open suggestion has any screenshots, the tab shows an empty state noting there are none right now. Screenshots often appear here after [Promptless Capture](/docs/get-the-most-out/screenshots) regenerates them following a UI change.
...
- **Knowledge base files**: reads from your [Knowledge Base](https://app.gopromptless.ai/settings/knowledge)—such as contribution guidelines or style rules—shown inline at the point in the sequence where the agent consulted them. Each one is labeled "Read from knowledge base" and links to that file in the [Agent Knowledge Base editor](/docs/get-the-most-out/agent-knowledge-base#view-files) in a new tab.
...
If the agent used any of [your own skills](/docs/connect/doc-locations/how-promptless-learns-your-docs#use-your-existing-skills), a "Used N of your skills" callout appears next to the summary, so you can see when Promptless applied a workflow you authored. When Promptless delegates research, a "N research agents" callout sits alongside the summary.
