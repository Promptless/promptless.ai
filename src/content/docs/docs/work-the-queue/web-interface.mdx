...
If the agent used any of [your own skills](/docs/configuring-promptless/doc-collections/how-promptless-learns-your-docs#use-your-existing-skills), a "Used N of your skills" callout appears next to the summary, so you can see when Promptless applied a workflow you authored.
