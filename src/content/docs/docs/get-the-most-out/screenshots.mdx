...
<Aside type="note">
  Promptless Capture generates screenshots and keeps them current; to review the screenshots already attached to your open suggestions, use the [Screenshot Updates](/docs/work-the-queue/web-interface#screenshot-updates) tab.
</Aside>
