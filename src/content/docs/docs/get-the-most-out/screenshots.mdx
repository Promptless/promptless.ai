...
Promptless Capture needs credentials to authenticate with your application. Store them as [environment variables](/docs/scale/environment-variables) in your Promptless dashboard **Settings**, on the **Environment Variables** tab.
