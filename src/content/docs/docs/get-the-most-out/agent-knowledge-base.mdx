...
In the left sidebar, open **Configure** and select **Agent Knowledge Base** (the book icon). If you have more than one docs repository connected, choose the one you want from the dropdown.
