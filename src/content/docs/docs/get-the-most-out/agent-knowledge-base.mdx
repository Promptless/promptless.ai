...
<img src="https://promptless-customer-doc-assets.s3.us-east-2.amazonaws.com/docs-images/org_3DaVKUzHgjyjaODgCPaDmjXezqp/agent-knowledge-base-editor-detail-f93086d3.png" alt="The file editor showing doc_workflow/changelog_guidelines.md selected in the Files tree, its file-path header, its line-numbered markdown source, and the Save button in the top-right" />
