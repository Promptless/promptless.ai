...
Today, Promptless posts the top-level summary comment. The acknowledgement, inline comments, direct edits, and formal review state described in the workflow above will take effect once that capability ships.
