...
<img src="https://promptless-customer-doc-assets.s3.us-east-2.amazonaws.com/docs-images/org_3DaVKUzHgjyjaODgCPaDmjXezqp/new-task-composer-deep-analysis-dd2c099d.png" alt="New Task composer with Mode set to Deep analysis, showing the Doc Collection chip set to Let Promptless decide, the Mode chip, the three-segment Notify toggle, an empty instructions field with a paperclip and submit arrow, the Auto-create PRs chip, and the Use a template rail with four template cards" />

<Steps>
  1. **Open New Task.** Click **New Task** in the sidebar. You can also use the [Deep Analysis deep link](https://app.gopromptless.ai/new-task?deep_analysis=true), which opens New Task with **Deep analysis** already selected in the **Mode** chip.
