...
<Aside type="tip">
  Auditing, remediating, or restructuring an existing docs set? See [Audit and keep your docs healthy](/docs/audit/keep-docs-healthy) for how Deep Analysis fits alongside Vale, Doc Detective, and redirects on those jobs.
</Aside>
