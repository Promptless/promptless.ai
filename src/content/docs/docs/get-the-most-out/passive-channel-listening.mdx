...
For Slack trigger details, see [Slack messages](/docs/connect/triggers/slack-messages). For Teams trigger details, see the [Triggers](/docs/connect/triggers) overview. For the full set of match fields, see the [Configuration Reference](/docs/reference/configuration-reference#triggers).
