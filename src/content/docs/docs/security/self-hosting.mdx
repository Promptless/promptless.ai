...
slug: docs/security/self-hosting
type: landing
tags:
  - security
  - landing
...
<LinkCard title="Kubernetes Deployment Guide" href="/docs/security/self-hosting/kubernetes-helm" description="Complete installation guide for deploying Promptless on Kubernetes using Helm charts" />
