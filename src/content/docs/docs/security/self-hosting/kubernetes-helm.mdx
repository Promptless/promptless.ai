...
slug: docs/security/self-hosting/kubernetes-helm
type: guide
tags:
  - security
  - self-hosting
...
This guide is part of the [Self-Hosting Overview](/docs/security/self-hosting). If you're still evaluating whether to self-host, start there.
