...
Leave both fields empty (or omit them) to give Promptless access to everything the connected account can read. For the full schema, see the [Configuration Reference](/docs/configuring-promptless/configuration-reference#context-sources).
