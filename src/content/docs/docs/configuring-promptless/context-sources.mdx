...
<CardGroup cols={2}>
  ...
  <Card title="Notion" iconSrc="/assets/notion-logo.svg" iconAlt="Notion logo" href="/docs/configuring-promptless/context-sources/notion">
    Search Notion pages and databases for product specs, internal documentation, and team knowledge
  </Card>

  <Card title="Google Drive" iconSrc="/assets/google-drive-logo.svg" iconAlt="Google Drive logo" href="/docs/configuring-promptless/context-sources/google-drive">
    Search Google Drive and read Docs, Sheets, and Slides for product specs, internal notes, and reference material
  </Card>
</CardGroup>
...
When a GitHub PR references a Google Doc containing feature specifications, Promptless automatically fetches that document's content. It also searches your Drive for related material, ensuring new docs align with existing feature definitions and terminology.
...
See the [Configuration Reference](/docs/configuring-promptless/configuration-reference#context-sources) for the complete YAML schema.
