...
<CardGroup cols={2}>
  ...
  <Card title="Slite" iconSrc="/assets/slite-logo.svg" iconAlt="Slite logo" href="/docs/configuring-promptless/context-sources/slite">
    Search Slite notes for internal documentation, product specs, and team knowledge
  </Card>
</CardGroup>
