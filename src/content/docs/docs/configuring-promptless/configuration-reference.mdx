...
View and edit your configuration in the dashboard at [app.gopromptless.ai/configuration](https://app.gopromptless.ai/configuration). The editor provides:
...
All organization members can view the configuration to understand how Promptless is set up. Only organization admins can edit and save changes—non-admins see a read-only editor with "View only — admins can edit" displayed instead of the Save button.
