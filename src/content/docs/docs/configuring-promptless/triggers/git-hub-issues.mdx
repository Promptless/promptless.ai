...
<Note>
If no doc collections are configured, Promptless will post a comment explaining that no matching configuration was found. This helps you understand why no documentation update was triggered.
</Note>
...
<Info>
GitHub Issues triggers require the GitHub App installation. See the [GitHub Integration](/docs/integrations/github-integration) setup guide if you haven't connected GitHub yet.
</Info>
