...
When Promptless creates documentation suggestions from Teams triggers, it can reply directly in the Teams thread with:

- A summary of the documentation update
- An Adaptive Card with action buttons to review in Promptless, view the docs PR, or create a PR
