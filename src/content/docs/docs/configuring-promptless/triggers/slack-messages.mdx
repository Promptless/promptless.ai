...
@Promptless mentions and message actions work automatically when the Slack integration is connected—no configuration required. See the [Configuration Reference](/docs/configuring-promptless/configuration-reference#triggers) for details.
