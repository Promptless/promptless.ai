...
<Tip title="Message Edits Don't Trigger Promptless">
Editing a Slack message that mentions @Promptless won't trigger a new run—Promptless only responds to new messages. To fix a typo or update your instructions, send a follow-up message or reply in the same thread.
</Tip>
