...
| 409 | `no_eligible_pipelines` | No doc collections are configured for your organization, or the specified `doc_collection_id` does not match a configured doc collection |
