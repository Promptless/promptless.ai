...
2. All other filters still apply: repository scope, doc collection readiness, and directory filters
...
- The repository must be in scope for at least one of your projects
