...
{/* step { "goTo": "$DEFINED_ORIGIN/docs/configuring-promptless/doc-collections/doc-detective-integration" } */}

{/* step { "find": "Doc Detective Integration" } */}

{/* step { "checkLink": "https://docs.doc-detective.com/" } */}

{/* step { "checkLink": "https://github.com/doc-detective/doc-detective" } */}

{/* step { "checkLink": "https://github.com/doc-detective/agent-tools" } */}
