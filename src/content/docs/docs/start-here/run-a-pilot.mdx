...
See our [Setup & Quickstart guide](/docs/start-here/quickstart) for integration instructions.
...
<Steps>
  <Step title="Understand your Promptless setup">
    Review your configuration and how [triggers, context sources, and documentation platforms](/docs/start-here/how-promptless-works) work for your team
  </Step>
