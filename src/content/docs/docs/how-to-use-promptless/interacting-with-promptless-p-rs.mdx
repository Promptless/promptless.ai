...
{/* test {"testId": "interacting-with-promptless-prs-content"} */}
{/* step {"goTo": "https://promptless.ai/docs/how-to-use-promptless/interacting-with-promptless-p-rs"} */}
{/* step {"find": "Interacting with Promptless PRs"} */}
...
{/* step {"find": "Comment trigger modes"} */}
...
{/* step {"find": "Reviewing in the dashboard"} */}
...
{/* step {"find": "Two ways of providing feedback"} */}
...
{/* step {"find": "Examples of feedback you can give to Promptless"} */}
