...
{/* test {"testId": "managing-environment-variables-content"} */}
{/* step {"goTo": "https://promptless.ai/docs/how-to-use-promptless/managing-environment-variables"} */}
{/* step {"find": "Managing Environment Variables"} */}
...
{/* step {"find": "Adding Environment Variables"} */}
...
{/* step {"find": "Keeping Secrets Secure"} */}
...
{/* step {"find": "Example: Screenshot Capture Credentials"} */}
...
{/* step {"find": "Updating and Deleting Variables"} */}
