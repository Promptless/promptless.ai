...
{/* test {"testId": "agent-knowledge-base-content"} */}
{/* step {"goTo": "https://promptless.ai/docs/how-to-use-promptless/agent-knowledge-base"} */}
{/* step {"find": "Agent Knowledge Base"} */}

Promptless updates these files automatically as it learns from your feedback, but you can also edit them directly.

{/* step {"find": "Accessing the Agent Knowledge Base"} */}
...
{/* step {"find": "Recent Updates by Promptless"} */}
...
{/* step {"find": "Knowledge Base Files"} */}
...
{/* step {"find": "Viewing and Editing Files"} */}
...
{/* step {"find": "How Promptless Uses These Files"} */}
