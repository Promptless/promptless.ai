...
- **Knowledge base files**: files from your [Knowledge Base](https://app.gopromptless.ai/settings/knowledge)—such as contribution guidelines or style rules—that the agent consulted while handling the trigger.
