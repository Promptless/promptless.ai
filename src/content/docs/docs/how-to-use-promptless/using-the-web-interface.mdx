...
When reviewing suggestions that modify Markdown files, you can preview how the rendered content will look. Click **Preview Markdown** in the file card header to open a preview modal.

The preview shows your changes with GitHub-style diff highlighting—added content appears with a green left rail and light green background, removed content with a red left rail and light red background. The modal scrolls to match your position in the code editor.

Markdown preview is available for `.md`, `.mdx`, and `.markdown` files. External links open in new tabs. Relative links and images show placeholder text since they can't be resolved outside your docs site.
