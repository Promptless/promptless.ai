...
The suggestions list shows all documentation suggestions from Promptless. Use the tabs at the top to filter by status:

- **Ready**: Suggestions waiting for your review that don't have a pull request yet
- **PR Open**: Suggestions with an open pull request in your docs repository
- **Closed**: Suggestions that have been merged or rejected

Suggestions approaching auto-archive show an orange **Archiving soon** chip. Hover over the chip for details on the auto-archive behavior. Viewing or editing a suggestion resets the timer.
