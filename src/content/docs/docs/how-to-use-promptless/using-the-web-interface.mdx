...
- **Docs target**: A chip with a document icon shows which doc collection the suggestion targets. Hover over the chip to see the full repository path—especially useful if your organization has multiple doc collections.
