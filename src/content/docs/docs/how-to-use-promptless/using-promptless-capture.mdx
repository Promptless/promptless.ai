...
{/* test {"testId": "using-promptless-capture-content"} */}
{/* step {"goTo": "https://promptless.ai/docs/how-to-use-promptless/using-promptless-capture"} */}
{/* step {"find": "Using Promptless Capture"} */}
...
{/* step {"find": "Setting Up Credentials"} */}
...
{/* step {"find": "When Screenshots Update Automatically"} */}
