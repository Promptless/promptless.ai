...
<Aside type="tip">
  You can set up notifications by hand as this page describes, or ask Promptless in Slack or Microsoft Teams to do it for you. For example, "@Promptless send suggestion notifications to my #docs-review channel." See [Ask Promptless to update your configuration](/docs/get-the-most-out/ask-promptless-to-update-config).
</Aside>
