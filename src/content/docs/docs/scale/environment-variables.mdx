...
<figure>
  <img src="https://promptless-customer-doc-assets.s3.us-east-2.amazonaws.com/docs-images/org_3DaVKUzHgjyjaODgCPaDmjXezqp/env-vars-settings-page-279aa2a4.png" alt="Promptless Settings page with Agent Env Vars selected, showing the variables table with Key, Value, Created, and Actions columns, Update and Delete buttons on each row, and an empty Add Variable form below the table" />
