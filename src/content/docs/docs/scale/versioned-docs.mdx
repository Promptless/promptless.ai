...
<Aside type="tip">
  You can set this up by hand as this page describes, or ask Promptless in Slack or Microsoft Teams to do it for you. For example, "@Promptless set my acme/docs collection default branch to v2 and only trigger on PRs targeting v2." See [Ask Promptless to update your configuration](/docs/get-the-most-out/ask-promptless-to-update-config).
</Aside>
