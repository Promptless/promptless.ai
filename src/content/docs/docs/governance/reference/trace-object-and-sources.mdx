...
description: The native session sources the host runtime ingests and the canonical trace object the worker stores for each session.
...
| `context_artifacts` | Analysis-context artifacts captured for the session.                           |
