...
| [`pig` toolchain](https://github.com/Promptless/instruction-hub-toolchain) and publishing CI | An author's machine and your CI runners | Validate source, build plugins, and publish releases                    | Hub source and repository publishing permissions          |
...
| Trace bucket      | Your cloud account                | Store raw trace chunks and reconstructed sessions                                                           | Private S3 bucket and analyzer access                                      |
...
The deployed trace analyzer service is named `instruction-hub-worker`. Its analysis component is called the **Friction Analyzer**. These names refer to a service and a component inside it; you do not install two analysis services.
