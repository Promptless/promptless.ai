...
description: Understand where PIG stores traces, what Promptless and your model provider receive, and which credentials connect each component.
...
Keeping raw traces in your bucket does not mean that every detail derived from a trace remains there. Review access to Promptless and the connected repository alongside access to your trace storage.
