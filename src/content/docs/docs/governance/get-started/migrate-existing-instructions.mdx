...
| General code review procedure                        | Share                                     | `assets/skills/review-code/SKILL.md` in `dev`  |
...
For a shared passage in `AGENTS.md` or `CLAUDE.md`, write a focused skill with a description explaining when it applies. Keep the original repository file's local instructions. The [setup guide's example](/docs/governance/get-started/set-up-your-instruction-hub#write-your-first-skills) provides a starting format.
...
The migration is complete when teammates can install the published release, complete the intended tasks, and identify where to propose the next instruction change. Trace collection is optional; add it later with [Enroll your hosts](/docs/governance/get-started/enroll-your-hosts).
