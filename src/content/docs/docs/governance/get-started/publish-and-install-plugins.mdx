...
description: Compile a hub to target-native plugins with pig build, publish through the GitHub Action, and install the plugins on your fleet.
...
Once your [Instruction Hub](/docs/governance/get-started/set-up-your-instruction-hub) validates, you compile it to plugins, publish those plugins, and install them on your fleet. The `pig` toolchain does the compiling; a thin GitHub Action does the publishing.
