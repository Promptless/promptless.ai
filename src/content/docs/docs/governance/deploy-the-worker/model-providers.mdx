...
The model configuration takes effect with the rest of the analysis settings: activation time and quiet window. Use a real session to [verify successful analysis](/docs/governance/deploy-the-worker/verify-your-deployment).
