...
<Steps>
  ...
  2. Start a new agent session after the [backlog cutoff you set for this installation](/docs/governance/deploy-the-worker/enable-trace-analysis). Use an installed Instruction Hub skill and complete the session normally.
