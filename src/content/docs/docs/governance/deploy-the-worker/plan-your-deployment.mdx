...
<Steps>
  1. Open **PIG → Settings** and, under **Add analyzer**, enter a name such as `production-us-east-2` and click **Add analyzer**.
  2. Copy the credential into your secret manager. It is shown once and cannot be retrieved after you dismiss it, leave Settings, or switch organizations.
