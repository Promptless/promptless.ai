...
Use the [model-provider reference](/docs/governance/deploy-the-worker/model-providers) for accepted endpoint shapes and authentication. Create Repo Issues and Propose Remediations use write access granted to the connected GitHub App for the selected repositories. A successful analysis clone does not verify that access.
