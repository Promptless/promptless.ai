...
This pause stops version updates to the worker software. To pause trace analysis, see [Enable and pause trace analysis](/docs/governance/deploy-the-worker/enable-trace-analysis).
