...
For more details, see our [Slack Integration documentation](/docs/integrations/slack-integration) and [Reviewing from Slack and Teams](/docs/work-the-queue/reviewing-from-slack-and-teams#4-passive-channel-listening).
