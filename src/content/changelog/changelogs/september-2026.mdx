...
* **Collect Cursor sessions as native traces:** Cursor joins Claude Code, Codex, and Claude Desktop as a native trace source for Promptless Instruction Governance. Once your analyzer reports Cursor support, the default enrollment policy adds Cursor. An enrolled Cursor host then uploads its sessions to your analyzer after browser approval. See [Enroll your hosts](/docs/governance/get-started/enroll-your-hosts) and [Trace object and sources](/docs/governance/reference/trace-object-and-sources).
