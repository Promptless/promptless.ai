...
subtitle: Backfill status and suggestions are now visible to all organization members, and suggestion comments in the dashboard now render Markdown, support teammate @-mentions, and stay visible after their referenced text changes.
