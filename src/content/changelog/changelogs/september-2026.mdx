...
subtitle: Sturdier trigger setup, clearer Slack connections, follow your tasks to the finish from your editor, backfill status and suggestions visible to all organization members, and Markdown-rendered suggestion comments that stay visible after their referenced text changes.
