...
subtitle: Backfill status and suggestions are now visible to all organization members, suggestion comments in the dashboard now render Markdown and stay visible after their referenced text changes, and Promptless confirms receipt on a Jira issue as soon as it picks up a request.
