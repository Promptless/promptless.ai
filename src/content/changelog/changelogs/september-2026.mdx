...
subtitle: Follow your tasks to the finish from your editor, passive listening gets easier to set up, backfill status and suggestions now visible to all organization members, and suggestion comments in the dashboard now render Markdown and stay visible after their referenced text changes.
