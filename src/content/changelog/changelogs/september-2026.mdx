...
* **Grant missing Slack permissions on your existing connection:** When your connected Slack workspace is missing a permission that a feature needs, the Slack card now shows a callout naming the missing permissions with an **Update connection** button. Clicking it re-runs Slack authorization to add the permissions, and your connection, channels, and configuration stay intact.
