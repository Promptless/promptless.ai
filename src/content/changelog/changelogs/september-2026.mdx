...
* **Coda integration:** Connect your Coda workspace to Promptless as a read-only context source. Once connected, Promptless can search your Coda docs by name and read page content when creating documentation suggestions, so your docs reflect the product knowledge your team keeps in Coda. Generate a personal API token in Coda, then connect it from the [Integrations page](https://app.gopromptless.ai/integrations).
