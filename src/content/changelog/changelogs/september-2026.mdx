...
* **Bitbucket removed from source-control integrations:** Bitbucket is no longer available as a source-control integration, and its documentation has been removed. Promptless connects to your source control through [GitHub and GitLab](/docs/for-docs/connect/source-control).
