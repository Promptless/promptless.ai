...
subtitle: Sturdier trigger setup, clearer Slack connections, backfill status and suggestions visible to all organization members, and Markdown-rendered suggestion comments that stay visible after their referenced text changes.
