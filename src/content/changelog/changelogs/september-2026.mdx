...
subtitle: Resume a pending Slack admin-approval install from the Integrations page, backfill status and suggestions are now visible to all organization members, and suggestion comments now render Markdown and stay visible after their referenced text changes.
