...
* **Answer a clarifying question over MCP, in every organization:** When a Promptless task finishes by asking a clarifying question, you can now answer it in your MCP editor—Claude Code, Cursor, or another—and Promptless continues the work in a new task. It's available to every organization. See [MCP triggers](/docs/for-docs/connect/triggers/mcp#answer-a-clarifying-question).
