...
* **Choose the trace backlog when you enable analysis:** You can now choose how much accumulated trace history the analyzer processes when you enable trace analysis for a worker installation—process all traces, or set a date-and-time cutoff. Your selection persists per installation, so pausing analysis keeps it and resuming lets you choose a backlog again. See [Enable and pause trace analysis](/docs/governance/deploy-the-worker/enable-trace-analysis).
