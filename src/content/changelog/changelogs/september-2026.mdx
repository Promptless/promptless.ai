...
subtitle: Promptless now proposes Vale rules from your style guidance during doc collection analysis, backfill status and suggestions are visible to all organization members, and suggestion comments in the dashboard render Markdown and stay visible after their referenced text changes.
