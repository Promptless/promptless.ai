...
* **Slack Link Org Switching:** Fixed Slack notification links showing 404 errors for users who belong to multiple Promptless organizations. Clicking a link now switches to the correct organization automatically. If the recipient isn't a member, an overlay explains the issue and shows their available organizations—the URL stays unchanged so they can reload after being invited.
