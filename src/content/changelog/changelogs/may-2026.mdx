...
* **Native Slack thinking status:** When you @mention Promptless or send it a DM, Slack now shows a native "Thinking..." status indicator instead of a thread reply. This reduces noise in your threads while still letting you know Promptless is working. If your Slack workspace doesn't support AI assistant thread status, Promptless falls back to the previous thread reply behavior automatically.
