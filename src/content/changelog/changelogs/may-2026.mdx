...
* **Pre-install code location questions:** The Connect docs step now opens with a "Tell us where your code lives" screen before the GitHub App install. Two quick questions ask where your docs-as-code live (GitHub.com or elsewhere) and where your engineers open pull requests (GitHub.com, GitHub Enterprise Cloud, GitLab.com, or Bitbucket.com). Selecting a self-hosted platform like GitHub Enterprise Server, GitLab Self-Managed, or Bitbucket Data Center prompts you to book a call with our team. These upfront questions determine which repositories the GitHub App needs access to, so your admin only has to approve once.
