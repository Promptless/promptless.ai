...
* **PR event badges on Triggers & Analysis:** GitHub PR trigger cards on the Triggers & Analysis tab now show colored badges for each event type—blue for opened, purple for merged, green for approved. When a single PR generates multiple triggers at different stages, these badges help you tell them apart at a glance.
