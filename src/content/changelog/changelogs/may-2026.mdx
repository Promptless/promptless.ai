...
* **Instant Slack channel listening:** Passive channel listening now triggers immediately when messages are posted—no more waiting for the previous 10-minute quiet window. Thread replies in channels where Promptless has participated also trigger immediately with embedded thread context.
