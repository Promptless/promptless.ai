...
* **Linear Integration Token Refresh:** Fixed Linear OAuth tokens expiring and causing silent integration failures. Tokens now refresh automatically before expiration. If you connected Linear before this fix, your integration will show "Reconnect required" in the dashboard—disconnect and reconnect Linear once to restore full functionality. New connections work seamlessly.
