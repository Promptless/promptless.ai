...
* **API access for doc collection management:** Organization API keys (`plk_...`) can now list, create, edit, and delete doc collections programmatically. Use the same key you use for triggers to manage your projects via the API. See [API Triggers](/docs/configuring-promptless/triggers/api-triggers#managing-doc-collections-via-api) for endpoint details.
