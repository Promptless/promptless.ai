...
* **Multi-Org GitHub Connect:** Connect multiple GitHub organizations to a single Promptless account. After linking your first org, a "Connect another GitHub Org" option appears in settings. Repos from all connected orgs appear in project dropdowns, prefixed with the org name (e.g., `acme/docs`) for easy disambiguation.
