...
* **Shift-Click Range Select in Bulk Mode:** In the suggestions list bulk select mode, shift-click a checkbox to select or deselect all suggestions between your last click and the current one—non-selectable rows (closed or already-published suggestions) are automatically skipped.
