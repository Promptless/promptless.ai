...
* **Slack Installation Pending Flow:** When connecting Slack during onboarding, users without admin permissions now see an "Installation Pending" state with clear guidance—contact your admin, continue without Slack, or try again—instead of the onboarding wizard breaking.
