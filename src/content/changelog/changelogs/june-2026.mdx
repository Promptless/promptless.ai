---
title: June 2026
subtitle: File-first configuration, multiple doc collections during onboarding, redesigned suggestion cards with status pills, trigger timeline, bulk selection, sidebar suggestion count, and filtering improvements.
