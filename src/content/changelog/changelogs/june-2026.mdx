...
* **Duplicate GitHub integration cards:** Fixed a race condition during GitHub App installation that could create duplicate integration cards in the dashboard. Attempting to delete the duplicate would inadvertently remove both cards, leaving the organization without a working GitHub connection.
