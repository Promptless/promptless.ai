---
title: June 2026
subtitle: File-first configuration, Vale prose linting, multiple doc collections during onboarding, sidebar suggestion count, filtering improvements, and bug fixes.
