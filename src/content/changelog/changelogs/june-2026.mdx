---
title: June 2026
subtitle: File-first configuration, doc collection display names, multiple doc collections during onboarding, sidebar suggestion count, filtering improvements, and bug fixes.
