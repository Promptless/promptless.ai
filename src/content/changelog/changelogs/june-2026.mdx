...
* **Suggestions stranded after a doc collection's repository was removed:** Removing a repository from your `promptless.yaml` orphaned any in-flight suggestions targeting that doc collection—you couldn't view, publish, edit, or close them in the dashboard, and open documentation PRs were left stranded. These suggestions now fall back to the doc collection's retained repository settings, so you can finish reviewing, publishing, and closing them as usual.
