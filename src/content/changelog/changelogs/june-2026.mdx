---
title: June 2026
subtitle: File-first configuration, GitLab MR and Bitbucket PR replay parity, multiple doc collections during onboarding, sidebar suggestion count, filtering improvements, and bug fixes.
