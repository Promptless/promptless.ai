---
title: June 2026
subtitle: Doc agents use your existing skills, file-first configuration, doc collection display names, simplified onboarding, multiple doc collections, sidebar suggestion count, filtering improvements, and bug fixes.
