...
* **Org-aware suggestion link previews in Slack:** When you share a suggestion link in Slack, the link preview now shows "Documentation suggestion for &lt;Your Org&gt;" instead of generic Promptless metadata. This makes it easier to identify which organization a suggestion belongs to at a glance.
