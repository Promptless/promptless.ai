---
title: June 2026
subtitle: File-first configuration, multiple doc collections during onboarding, inline Slack research citations, sidebar suggestion count, filtering improvements, and bug fixes.
