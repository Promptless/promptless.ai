...
* **Microsoft Teams full features and channel picker:** Admins can now enable full features for the Microsoft Teams integration, giving Promptless read-only access to your teams and channels through Microsoft Graph. Once enabled, your synced channels appear in a picker when you select a Microsoft Teams notification channel in your configuration policies, so you no longer need to paste a raw conversation ID. Channel visibility is scoped to the authorizing admin's memberships: admin consent grants an org-wide permission, not org-wide visibility.
