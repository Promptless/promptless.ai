...
* **Self-serve Microsoft Teams connect:** Admins can now connect Microsoft Teams to Promptless without help from support. From the [Integrations page](https://app.gopromptless.ai/integrations), click **Connect Microsoft Teams**, sign in with Microsoft to link your tenant to your organization, then install the Promptless app package. See the [Microsoft Teams Integration](/docs/integrations/microsoft-teams-integration) setup guide.
