---
title: June 2026
subtitle: Doc agents use your existing skills, file-first configuration, GitLab merge request link resolution, simplified onboarding, multiple doc collections, sidebar suggestion count, filtering improvements, and bug fixes.
