...
* **Research breakdown shows Knowledge Base files and skills:** Each trigger's research breakdown—on the Triggers page and a suggestion's **Triggers & Analysis** tab—again summarizes what Promptless reviewed before drafting or skipping documentation, with cleaner repository-relative file paths. It now adds a **knowledge base files** category listing the [Knowledge Base](https://app.gopromptless.ai/settings/knowledge) files the agent read, such as contribution guidelines, and a "Used N of your skills" callout when the agent ran one of [your own skills](/docs/configuring-promptless/doc-collections/how-promptless-learns-your-docs#using-your-existing-skills). Each search also shows whether it ran against your doc collection or the agent's sandbox. See [Using the Web Interface](/docs/how-to-use-promptless/using-the-web-interface#research-breakdown).
