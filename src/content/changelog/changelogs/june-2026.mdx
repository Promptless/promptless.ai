---
title: June 2026
subtitle: Doc agents use your existing skills, file-first configuration, multiple doc collections during onboarding, sidebar suggestion count, filtering improvements, and bug fixes.
