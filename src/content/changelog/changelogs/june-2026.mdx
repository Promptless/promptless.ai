---
title: June 2026
subtitle: File-first configuration, GitLab merge request link resolution, multiple doc collections during onboarding, sidebar suggestion count, filtering improvements, and bug fixes.
