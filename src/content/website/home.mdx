...
<div class="pl-hero-v2-layout">
  ...
  <div class="pl-hero-v2-asides">
    <div id="pl-hero-aside-agents" class="pl-hero-v2-aside" role="group" aria-labelledby="pl-product-switcher-tab-agents" hidden>
      <div class="pl-stat-cards" data-section-tracked="improvement-stats">
        ...
        <div class="pl-stat-cards-grid not-content">
          ...
          <div class="pl-stat-card">
            <div class="pl-stat-card-label">Wall-Clock Time</div>
    ...
    <div id="pl-hero-aside-docs" class="pl-hero-v2-aside" role="group" aria-labelledby="pl-product-switcher-tab-docs">
      <TestimonialsVertical />
      <div class="pl-mobile-testimonials"><Testimonials /></div>
    </div>
  </div>
</div>
<div id="pl-below-fold-docs">
...
<div id="pl-below-fold-agents" hidden>
  <AgentGovernance />
</div>
{/* <ArcadeDemo /> */}
