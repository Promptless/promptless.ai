...
Nothing to configure. Promptless posts citations on any GitLab MR it opens or updates, regardless of how the MR was created. If you're already using Promptless with GitLab doc collections, citations appear on new MRs going forward.
