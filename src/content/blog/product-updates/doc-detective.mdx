...
You can view the full source file in [our docs repo](https://github.com/Promptless/docs/blob/main/src/content/docs/docs/integrations/slack-integration.mdx).
