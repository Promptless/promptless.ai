...
You can view the full source file in [our docs repo](https://github.com/Promptless/promptless.ai/blob/main/src/content/docs/docs/reference/integrations/slack.mdx).
