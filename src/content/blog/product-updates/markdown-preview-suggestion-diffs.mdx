...
The preview renders Markdown formatting, tables, code blocks, and inline HTML. MDX components like `<Callout>`, `<Tabs>`, or custom JSX elements display as styled code blocks with a light background and border, keeping their structure intact instead of reflowing into paragraph text. The surrounding prose, headings, and formatting render correctly, so what you see is close to what you'll publish.
