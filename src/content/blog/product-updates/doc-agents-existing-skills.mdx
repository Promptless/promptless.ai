...
To add guidance about when Promptless should use which skills, create a `PROMPTLESS.md` in your Agent Knowledge Base. See [How Promptless Learns Your Docs](/docs/for-docs/connect/doc-locations/how-promptless-learns-your-docs#use-your-existing-skills) for reference.
