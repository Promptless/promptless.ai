...
[Documentation drift](/blog/technical/documentation-drift-detection-problem) is the slow divergence between what your product does and what your docs say. A typical API-first company ships dozens of changes per sprint. Some of those changes affect documented behavior. Without a systematic coverage process, accuracy gaps compound across releases.
...
[This is context failure in practice](/blog/technical/agent-context-engineering). The model operated correctly on bad information. Better model quality won't change the outcome. A more accurate knowledge base will.
