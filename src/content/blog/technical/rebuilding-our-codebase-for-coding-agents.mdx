...
- **Output per engineer went up 3-5x** (according to [Weave](https://weaveos.com)’s models, which benchmark engineering output across orgs). Percentile went from 58th to >90th among similar eng teams, so it wasn’t just model improvements.
