...
For a deeper look at how to use search analytics alongside other documentation metrics, [Developer Documentation ROI: The Metrics That Actually Matter](/blog/technical/developer-documentation-roi) covers the full measurement stack.
