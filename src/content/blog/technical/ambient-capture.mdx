...
Sometimes, the system can go one step further to triangulate with databases to figure out if it's an unauthorized entry, an irregular behavior, etc. So that security professionals get the most salient signals
