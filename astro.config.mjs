          ...
          [
            {
              ...
              items: [
                { label: 'Start Here', items: [{ autogenerate: { directory: 'docs/start-here' } }] },
                {
                  label: 'Connect',
                  items: [
                    {
                      ...
                      items: [
                        ...
                        { autogenerate: { directory: 'docs/connect/triggers' } },
                      ],
                    },
                    {
                      ...
                      items: [
                        ...
                        { autogenerate: { directory: 'docs/connect/context-sources' } },
                      ],
                    },
                ...
                { label: 'Work the queue', items: [{ autogenerate: { directory: 'docs/work-the-queue' } }] },
                { label: 'Get the most out of it', items: [{ autogenerate: { directory: 'docs/get-the-most-out' } }] },
                  ...
                  items: [
                    {
                      ...
                      items: [
                        ...
                        { autogenerate: { directory: 'docs/reference/integrations' } },
                      ],
                    },
