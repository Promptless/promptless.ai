...
entry_point: /docs/for-docs/getting-started/setup-quickstart
...
steps:
  - { stage: "Install source-control app", doc: /docs/for-docs/integrations/github-integration, exists: true, note: "Also github-enterprise-integration, bitbucket-integration" }
  - { stage: "Choose access scope (read-only / repo selection)", doc: "/docs/for-docs/integrations/github-integration#permissions-and-scope", exists: partial, note: "Access-scope guidance scattered; OSS read-only path lives elsewhere" }
  - { stage: "Configure triggers", doc: /docs/for-docs/configuring-promptless/triggers, exists: true, note: "PRs, commits, issues, Slack, Intercom, Teams, API" }
  - { stage: "Connect context sources", doc: /docs/for-docs/configuring-promptless/context-sources, exists: true, note: "Jira, Linear, Notion, Confluence" }
  - { stage: "Tell Promptless where docs live", doc: /docs/for-docs/configuring-promptless/doc-collections/git-hub-repos-docs-as-code, exists: true }
  - { stage: "Verify the connection is live (no expired token)", doc: "/docs/for-docs/configuring-promptless/connection-health", exists: false, note: "[GAP] No troubleshooting page for silent auth/token failures" }
---
