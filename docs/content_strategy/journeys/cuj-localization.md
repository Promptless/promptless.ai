...
steps:
  - { stage: "Model localized docs as collections/locales", doc: "/docs/for-docs/configuring-promptless/doc-collections/localization", exists: false, note: "[GAP] No localization page" }
  - { stage: "Propagate source changes to each locale", doc: "/docs/for-docs/configuring-promptless/localization/propagation", exists: false, note: "[GAP] one OSS project's translations years behind; others needed locale upkeep" }
  - { stage: "Integrate with a TMS (e.g. Phrase)", doc: "/docs/for-docs/integrations/tms", exists: false, note: "[GAP] one enterprise team requires a TMS hook" }
  - { stage: "Human-review machine translations", doc: /docs/for-docs/how-to-use-promptless/providing-feedback, exists: partial }
---
