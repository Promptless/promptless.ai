...
entry_point: /docs/for-docs/getting-started/promptless-oss
...
steps:
  - { stage: "Understand the OSS program & eligibility", doc: /docs/for-docs/getting-started/promptless-oss, exists: true }
  - { stage: "Install the read-only GitHub app", doc: "/docs/for-docs/getting-started/promptless-oss#install-the-github-app", exists: true, note: "OSS quickstart documents the read-only (public-repo) GitHub app" }
  - { stage: "Connect multiple project repos", doc: /docs/for-docs/configuring-promptless/doc-collections/git-hub-repos-docs-as-code, exists: true }
