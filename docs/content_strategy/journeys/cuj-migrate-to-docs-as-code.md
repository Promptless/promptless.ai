...
entry_point: /docs/for-docs/configuring-promptless/doc-collections/git-hub-repos-docs-as-code
...
steps:
  - { stage: "Confirm docs-as-code is the prerequisite", doc: /docs/for-docs/configuring-promptless/doc-collections/git-hub-repos-docs-as-code, exists: true }
  - { stage: "Choose a target SSG (Mintlify, Starlight, VitePress)", doc: "/docs/for-docs/migrations/choosing-a-platform", exists: false, note: "[GAP] No migration guidance" }
  - { stage: "Migrate from a specific source platform", doc: "/docs/for-docs/migrations/from-doc360", exists: false, note: "[GAP] Doc360/ReadMe/Fern/HubSpot/RoboHelp all named; none documented" }
  - { stage: "Preserve URLs / redirects", doc: "/docs/for-docs/migrations/redirects", exists: false, note: "[GAP]" }
---
