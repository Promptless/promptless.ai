const en = {
  ...
  startHere: 'Start here', recent: 'Recently opened', devIndex: 'Dev index', rebuildIndex: 'Rebuild index',
  staleIndex: 'Content has changed since the index was generated. Run npm run build, then reload this page.',
...
const es: typeof en = {
  ...
  startHere: 'Empieza aquí', recent: 'Abierto recientemente', devIndex: 'Índice local', rebuildIndex: 'Regenerar índice',
  staleIndex: 'El contenido cambió después de generar el índice. Ejecuta npm run build y recarga esta página.',
